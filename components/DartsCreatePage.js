...
export function DartsCreatePage() {
  ...
  const handleSubmit = () => {
    axios.post('https://darts.sulla.hu/darts', form)
      ...
      .catch((error) => {
        console.log(error);
        Alert.alert('Error', 'Something went wrong while adding dartsozó.');
      });
  };
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Új dartsozó</Text>

      <TextInput
        style={styles.input}
        placeholder="Dartsozó neve"
        value={form.name}
...
export default DartsCreatePage;
